...
/**
 * Created by chaleamsuk on 15/11/2559.
 */
    ...
    public JSONObject makeHttpRequest(String url, String method,
        ...
        try {
            ...
            if(method.equals("POST")){
                ...
                try {
                    Log.e("Param :", " " +convertStreamToString(httpPost.getEntity().getContent()));
                ...
                Log.e("Status Response :",""+httpResponse.getStatusLine().getStatusCode());
